# MUTANT (single seeded defect): sweep ordering: dropped % TWO_PI normalization of the relative bearing
"""
...
def sort_clockwise_sweep(
    ...
    def sweep_key(waypoint: Coordinate) -> tuple[float, float]:
        relative_bearing = bearing_from_centroid(waypoint) - start_bearing
        distance = math.hypot(

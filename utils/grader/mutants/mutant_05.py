# MUTANT (single seeded defect): start bearing: measured from home to centroid (reference reversed)
"""
...
def sort_clockwise_sweep(
    ...
    if home is not None and not math.isclose(
        ...
        east, north = east_north_coordinate_offset_m(
            home.lat, home.lon, centroid_lat, centroid_lon
        )
        start_bearing = math.atan2(east, north) % TWO_PI
